...
export const initialData: SeedData = {
  ...
  products: [
    {
      description:
        "Introducing the Tesla Chill Collection. The Apple iPhone 11 64GB Black has a premium, heavyweight exterior and soft fleece interior for comfort in any season. The sweatshirt features a subtle thermoplastic polyurethane T logo on the chest and a Tesla wordmark below the back collar. Made from 60% cotton and 40% recycled polyester.",
    ...
    {
      description:
        "The Xiaomi Poco M5 Dual Sim 64GB 4GB Black features a uniquely fit, quilted design for warmth and mobility in cold weather seasons. With an overall street-smart aesthetic, the jacket features subtle silicone injected Tesla logos below the back collar and on the right sleeve, as well as custom matte metal zipper pulls. Made from 87% nylon and 13% polyurethane.",
      ...
      type: "shirts",
      tags: ["jacket"],
      title: "Xiaomi Poco M5 Dual Sim 64GB 4GB Black",
      gender: "men",
    },
